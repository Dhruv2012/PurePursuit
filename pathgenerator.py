...
def click_event(event,x,y,flag,param):
    global waypoints,mouse_down,start_pos,img
    try:
        if mouse_down:
            tmp = img.copy()
            place_point(tmp,x,y,flag & cv2.EVENT_FLAG_SHIFTKEY, False)
...
# DISPLAY IMAGE GENERATED OF THE PATH 
...
#use of shift key
#check points saved in path are they global or local relative to start point
